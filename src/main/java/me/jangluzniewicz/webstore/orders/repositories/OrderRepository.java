...
public interface OrderRepository extends JpaRepository<OrderEntity, Long> {
  ...
  Page<OrderEntity> findAllByOrderDateBetweenOrderByOrderDateAscIdAsc(
      LocalDateTime orderDateAfter, LocalDateTime orderDateBefore, Pageable pageable);

  Page<OrderEntity> findAllByStatusIdAndOrderDateBetweenOrderByOrderDateAscIdAsc(
      Long statusId,
