...
class CategoryServiceTest {
    ...
    public void shouldThrowNotUniqueExceptionWhenCategoryAlreadyExists() {
        ...
        assertThrows(NotUniqueException.class, () -> categoryService.createNewCategory(categoryRequest));
    }
    ...
    public void shouldThrowNotUniqueExceptionWhenUpdatingToExistingCategory() {
        ...
        assertThrows(NotUniqueException.class, () -> categoryService.updateCategory(1L, categoryRequest));
    }
