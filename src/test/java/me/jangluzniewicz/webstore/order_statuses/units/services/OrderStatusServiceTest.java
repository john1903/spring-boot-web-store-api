...
class OrderStatusServiceTest {
    ...
    public void shouldCreateNewOrderStatusAndReturnOrderStatusId() {
        ...
        when(orderStatusRepository.existsByNameIgnoreCase(orderStatusRequest.getName())).thenReturn(false);
    ...
    public void shouldThrowNotUniqueExceptionWhenOrderStatusAlreadyExists() {
        ...
        when(orderStatusRepository.existsByNameIgnoreCase(orderStatusRequest.getName())).thenReturn(true);

        assertThrows(Exception.class, () -> orderStatusService.createNewOrderStatus(orderStatusRequest));
    }
    ...
    public void shouldReturnOrderStatusWhenGettingOrderStatusById() {
        ...
        when(orderStatusMapper.fromEntity(orderStatusEntity)).thenReturn(new OrderStatus(1L, "ACCEPTED"));
    ...
    public void shouldThrowNotUniqueExceptionWhenOrderStatusAlreadyExistsOnUpdate() {
        ...
        assertThrows(NotUniqueException.class, () -> orderStatusService.updateOrderStatus(1L, orderStatusRequest));
    }
    ...
    public void shouldThrowNotFoundExceptionWhenOrderStatusNotFoundOnUpdate() {
        ...
        assertThrows(NotFoundException.class, () -> orderStatusService.updateOrderStatus(1L, orderStatusRequest));
    }
    ...
    public void shouldThrowDeletionNotAllowedExceptionWhenDeletingOrderStatusWithDependencies() {
        ...
        doThrow(new DataIntegrityViolationException("", new ConstraintViolationException("", new SQLException(), "")))
                .when(orderStatusRepository).deleteById(1L);
    ...
    public void shouldThrowExceptionWhenWhenDataIntegrityViolationIsNotCausedByConstraintViolation() {
        ...
        assertThrows(DataIntegrityViolationException.class, () -> orderStatusService.deleteOrderStatus(1L));
    }
}