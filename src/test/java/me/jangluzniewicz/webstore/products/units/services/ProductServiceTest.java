...
class ProductServiceTest {
    ...
    public void shouldUpdateProductAndReturnProductId() {
        ProductRequest productRequest = new ProductRequest("Bicycle XXL", "Mountain bike",
                BigDecimal.valueOf(1200.0), BigDecimal.valueOf(10.0), 1L);
        ProductEntity savedEntity = new ProductEntity(1L, "Bicycle", "Mountain bike",
                BigDecimal.valueOf(1000.0), BigDecimal.valueOf(10.0), categoryEntity);
    ...
    public void shouldReturnPagedResponseWhenGettingFilteredProductsWithoutAnyFilters() {
        ...
        PagedResponse<Product> products = productService.getFilteredProducts(null, null,
                null, null, 0, 10);
    ...
    public void shouldReturnPagedResponseWhenGettingFilteredProductsWithCategoryIdFilter() {
        ...
        PagedResponse<Product> products = productService.getFilteredProducts(1L, null,
                null, null, 0, 10);
    ...
    public void shouldReturnPagedResponseWhenGettingFilteredProductsWithNameFilter() {
        ...
        PagedResponse<Product> products = productService.getFilteredProducts(null, "Bicycle",
                null, null, 0, 10);
    ...
    public void shouldReturnPagedResponseWhenGettingFilteredProductsWithPriceRangeFilter() {
        ...
        when(productRepository.findAllByPriceBetween(BigDecimal.valueOf(1000.0), BigDecimal.valueOf(2000.0), pageable))
                .thenReturn(page);
        when(productMapper.fromEntity(productEntity)).thenReturn(new Product(1L, "Bicycle",
                "Mountain bike", BigDecimal.valueOf(1000.0), BigDecimal.valueOf(10.0), category));

        PagedResponse<Product> products = productService.getFilteredProducts(null, null,
                BigDecimal.valueOf(1000.0), BigDecimal.valueOf(2000.0), 0, 10);
    ...
    public void shouldReturnPagedResponseWhenGettingFilteredProductsWithCategoryIdAndNameFilters() {
        ...
        when(productRepository.findAllByCategoryIdAndNameContainingIgnoreCase(1L, "Bicycle", pageable)).thenReturn(page);
        when(productMapper.fromEntity(productEntity)).thenReturn(new Product(1L, "Bicycle",
                "Mountain bike", BigDecimal.valueOf(1000.0), BigDecimal.valueOf(10.0), category));

        PagedResponse<Product> products = productService.getFilteredProducts(1L, "Bicycle",
                null, null, 0, 10);
    ...
    @Test
    public void shouldReturnPagedResponseWhenGettingFilteredProductsWithCategoryIdAndPriceRangeFilters() {
        ProductEntity productEntity = new ProductEntity(1L, "Bicycle", "Mountain bike",
                BigDecimal.valueOf(1000.0), BigDecimal.valueOf(10.0), categoryEntity);
        Pageable pageable = PageRequest.of(0, 10);
        Page<ProductEntity> page = new PageImpl<>(List.of(productEntity), pageable, 1);

        when(productRepository.findAllByCategoryIdAndPriceBetween(1L, BigDecimal.valueOf(1000.0),
                BigDecimal.valueOf(2000.0), pageable)).thenReturn(page);
        when(productMapper.fromEntity(productEntity)).thenReturn(new Product(1L, "Bicycle",
                "Mountain bike", BigDecimal.valueOf(1000.0), BigDecimal.valueOf(10.0), category));
    ...
    public void shouldReturnPagedResponseWhenGettingFilteredProductsWithNameAndPriceRangeFilters() {
        ...
        when(productRepository.findAllByNameContainingIgnoreCaseAndPriceBetween("Bicycle",
                BigDecimal.valueOf(1000.0), BigDecimal.valueOf(2000.0), pageable)).thenReturn(page);
        when(productMapper.fromEntity(productEntity)).thenReturn(new Product(1L, "Bicycle",
                "Mountain bike", BigDecimal.valueOf(1000.0), BigDecimal.valueOf(10.0), category));
    ...
    public void shouldReturnPagedResponseWhenGettingFilteredProductsWithAllFilters() {
        ...
        when(productRepository.findAllByCategoryIdAndNameContainingIgnoreCaseAndPriceBetween(1L, "Bicycle",
                BigDecimal.valueOf(1000.0), BigDecimal.valueOf(2000.0), pageable)).thenReturn(page);
        when(productMapper.fromEntity(productEntity)).thenReturn(new Product(1L, "Bicycle",
                "Mountain bike", BigDecimal.valueOf(1000.0), BigDecimal.valueOf(10.0), category));
